        ...
        <table>
                ...
                <?php
                    ...
                    else
                    {
                            ...
                            $result=mysqli_query($con,"SELECT * FROM user WHERE fullname LIKE '%".$se."%';");
                        ?><table  cellspacing="100"><?php
                           while($row = mysqli_fetch_array($result,MYSQLI_ASSOC)) {
                            echo "<tr style=\"heigth:200px;\">";
                            echo "<td style=\"width:700px;heigth:200px;padding:50px;font-size:30px;color:black; background-color:white;border-radius:white;border:1px solid gray;border-bottom:10px solid gray; border-spacing: 5px 10px;font-family:Comic Sans MS;\"><img src=\"us.png\" alt=\"Italian Trulli\" style=\"width:200px;heigth:50px;\"> ".$row['fullname']."</td> <br>";
                            echo "<td><a href=\"se.php?email=".$row['email']."\" style=\"text-decoration:none;\"><button style=\"padding:10px;border-radius:5px; font-size:20px;background-color:black;color:white;\">view posts</button></a></td>";
                            echo "</tr>";
                           }
